...
export default function MainPage({ lang }) {
    ...
    return (
        ...
        {lang === 'ua' && <div className='mainPageBox'>
                <h1>Про продукт</h1>
                <p>Трав'яні краплі Ermineral походять від племені даяків (Паланкарая, Центральний Калімантан), які добре відомі своїми методами ферментації. Цей місцевий метод добре зберігся протягом багатьох поколінь. На архіпелазі трав'яний настій використовують як альтернативну медицину для лікування таких серйозних захворювань, як діабет, інсульт, ниркова недостатність, хвороби серця, гіпертиреоз, катаракта, глаукома, виразки тощо.
