    ...
    return (
        <div className="recommendationBox">
            ...
            {language === 'ua' && <div className='text'>
                ...
                <p>Б) Після прийому настоянки почніть присідати (стільки разів, скільки у вас вийде). Скорочення великих мязів і вплив на діафрагму забезпечить хороший кровообіг і лімфоток. Завдяки цьому лікувальні компоненти настоянки швидко рознесуться по вашому тілу (особливо по лімфатичній системі).</p>
                <h3>2. Допоможіть організму розчиняти шлаки швидше.</h3>
                <p>Травяна настоянка запускає процес детоксикації (очищення організму). У звязку з цим відбувається розчинення шлаків і виведення їх з організму. Щоб сприяти цьому процесу, ми рекомендуємо збільшити споживання чистої води. Додайте додаткові 2-3 склянки чистої води на день. При цьому ліпше пити воду між прийомами їжі, в теплому вигляді (~40 С).</p>
                ...
                <p>Ваше здоров`я у ваших руках. Почніть інвестувати в красу, здоровя і довголіття просто зараз!</p>
            </div>}
